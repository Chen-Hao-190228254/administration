...
@Data
public class QuestionBankBeanDetailsDto {
    private Long id ;
    ...
    private Long status;
    List<OptionCodesDto> optionCodesDtoList;

    public QuestionBankBeanDetailsDto() {
    }

    public QuestionBankBeanDetailsDto(Long id) {
        this.id = id;
    }
}
